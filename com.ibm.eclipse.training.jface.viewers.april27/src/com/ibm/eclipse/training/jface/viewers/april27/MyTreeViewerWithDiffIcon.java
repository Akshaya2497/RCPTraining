 ...
 *
 */
public class MyTreeViewerWithDiffIcon extends ViewPart {
	...
	private class  TreeViewerContentProvider implements ITreeContentProvider {
		...
		private class  TreeViewerLableProvider extends LabelProvider{
			...
			public Image getImage(Object element) {
				...
				Bundle bundle = FrameworkUtil.getBundle(MyTreeViewerWithDiffIcon.class);
				
				//Get the path of image 
				URL imagePath = null; 
				if(element instanceof ProductBundle)
					imagePath= FileLocator.find(bundle,new Path("icons/parent.png"));  
				else if(element instanceof Product )
					imagePath  = FileLocator.find(bundle,new Path("icons/child.png"));  
				else 
					imagePath  = FileLocator.find(bundle,new Path("icons/default.png"));  
